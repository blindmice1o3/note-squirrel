...
public class TileMapHouseLevel02 extends TileMap {

    private String stringOfTiles;

    public TileMapHouseLevel02(GameCartridge gameCartridge, Scene.Id sceneID) {
    ...
    protected void initTextureAndSourceFile(Resources resources) {
        /////////////////////////////////////////////
        texture = Assets.cropHouseLevel02(resources);
        /////////////////////////////////////////////

        //text-source-file of HOUSE_LEVEL_02 stored as String.
        stringOfTiles = TileMapLoader.loadFileAsString(resources, R.raw.tile_house_level_02);
    }
