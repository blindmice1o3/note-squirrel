...
public class SceneLab extends Scene {
    ...
    public void getInputButtonPad() {
        ...
        if (inputManager.isaButtonPad()) {
            Log.d(MainActivity.DEBUG_TAG, "SceneLab.getInputButtonPad() a-button-justPressed");
        ...
        //b button
            ...
            Log.d(MainActivity.DEBUG_TAG, "SceneLab.getInputButtonPad() b-button-justPressed");
        ...
        //menu button (push State.START_MENU)
            ...
            Log.d(MainActivity.DEBUG_TAG, "SceneLab.getInputButtonPad() menu-button-justPressed");
