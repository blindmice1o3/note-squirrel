...
public class SceneCowBarn extends Scene {
    ...
    private Bitmap cropImageCowBarn(Resources resources) {
        Log.d(MainActivity.DEBUG_TAG, "SceneCowBarn.cropImageCowBarn(Resources resources)");
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        Log.d(MainActivity.DEBUG_TAG, "Bitmap cowBarnEmpty's (width, height): " + cowBarnEmpty.getWidth() + ", " + cowBarnEmpty.getHeight());
