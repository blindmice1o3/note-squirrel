...
public class SceneHothouse extends Scene {
    ...
    private Bitmap cropImageHothouse(Resources resources) {
        Log.d(MainActivity.DEBUG_TAG, "SceneHothouse.cropImageHothouse(Resources resources)");
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        Log.d(MainActivity.DEBUG_TAG, "Bitmap hothouseEmpty's (width, height): " + hothouseEmpty.getWidth() + ", " + hothouseEmpty.getHeight());
