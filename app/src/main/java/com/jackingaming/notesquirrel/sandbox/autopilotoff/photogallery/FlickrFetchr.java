...
public class FlickrFetchr {
    ...
    private static final String API_KEY = "52d937c81875d5031dd1bdf572c269e3";
    ...
    public ArrayList<GalleryItem> fetchItems(int page) {
        ...
        try {
            ...
            Log.i(TAG, "Before \"parseItems(ArrayList<GalleryItem>, XmlPullParser)\": " + items.size());
            parseItems(items, parser);
            Log.i(TAG, "After \"parseItems(ArrayList<GalleryItem>, XmlPullParser)\": " + items.size());
