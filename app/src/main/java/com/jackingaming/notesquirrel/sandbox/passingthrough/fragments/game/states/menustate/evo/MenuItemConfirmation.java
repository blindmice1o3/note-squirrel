    ...
    private void updateConfirmationMessage() {
        ...
        switch (indexBodyPartCategory) {
            ...
            case 3:
                ...
                break;
            default:
                Log.d(MainActivity.DEBUG_TAG, getClass().getSimpleName() + ".render(Canvas canvas) switch(indexBodyPartCategory)'s default.");
                break;
        }
                ...
                if (form instanceof FishForm) {
                    ...
                    switch (indexBodyPartCategory) {
                        case 0:
                            ...
                            Log.d(MainActivity.DEBUG_TAG, "setJaws: " + (FishStateManager.Jaws.values()[indexBodyPartSelected]).toString());
                        ...
                        case 1:
                            if (indexBodyPartSelected <= (FishStateManager.BodyTexture.values().length-1)) {
                                ...
                                Log.d(MainActivity.DEBUG_TAG, "setBodyTexture: " + (FishStateManager.BodyTexture.values()[indexBodyPartSelected]).toString());
                                ...
                                Log.d(MainActivity.DEBUG_TAG, "setBodySize: " + (FishStateManager.BodySize.values()[indexBodyPartSelected-(FishStateManager.BodyTexture.values().length)]).toString());
                        ...
                        case 2:
                            ...
                            Log.d(MainActivity.DEBUG_TAG, "setFinPectoral: " + (FishStateManager.FinPectoral.values()[indexBodyPartSelected]).toString());
                        ...
                        case 3:
                            ...
                            Log.d(MainActivity.DEBUG_TAG, "setCurrentTail: " + (FishStateManager.Tail.values()[indexBodyPartSelected]).toString());
                            expCost = FishStateManager.Tail.values()[indexBodyPartSelected].getCost();
                            break;
                        case 4:
                            break;
                        default:
                            Log.d(MainActivity.DEBUG_TAG, getClass().getSimpleName() + ".interpretInput() switch(indexBodyPartCategory)'s default.");
                            break;
                    }
                    ...
                    Log.d(MainActivity.DEBUG_TAG, getClass().getSimpleName() + ".interpretInput() " + expCost + " experience points DEDUCTED.");

                    // Pop twice to go back to MenuItemInitial.
                    MenuStateImplEvo.getInstance().getMenuItemManager().popMenuItemStack();
                    MenuStateImplEvo.getInstance().getMenuItemManager().popMenuItemStack();
                } else {
                    Log.d(MainActivity.DEBUG_TAG, "PLAYER IS NOT A FISH INSTANCE!!!");
                }
            } else if (menuItem == MenuItem.NO) {
                MenuStateImplEvo.getInstance().getMenuItemManager().popMenuItemStack();
            }
