...
import com.jackingaming.notesquirrel.sandbox.passingthrough.fragments.game.scenes.entities.frogger.Car;
import com.jackingaming.notesquirrel.sandbox.passingthrough.fragments.game.scenes.entities.frogger.Log;
...
public class SceneFrogger extends Scene {
    ...
    public void update(long elapsed) {
        ...
        if (entityManager.getEntities().size() < 12) {
            ...
            android.util.Log.d(MainActivity.DEBUG_TAG, "chanceToInstantiate: " + chanceToInstantiate);
            ...
            if (chanceToInstantiate <= 5) {
                ...
                android.util.Log.d(MainActivity.DEBUG_TAG, "controllerForNextEntityInstantiation: " + controllerForNextEntityInstantiation);
                int x = 0;
                int y = 0;
                int width = 0;
                int height = 0;
                ...
                switch (controllerForNextEntityInstantiation) {
                    ...
                    case 9:
                        ...
                        break;
                    default:
                        android.util.Log.d(MainActivity.DEBUG_TAG, getClass().getSimpleName() + ".update(long elapsed), switch (controllerForNextEntityInstantiation) construct's default block.");
                        break;
                }
            }
        }
    ...
    private void initFroggerSprites(Resources resources) {
        android.util.Log.d(MainActivity.DEBUG_TAG, getClass().getSimpleName() + ".initFroggerSprites(Resources resources) START...");
