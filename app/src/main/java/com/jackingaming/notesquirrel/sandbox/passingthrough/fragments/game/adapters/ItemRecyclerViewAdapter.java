package com.jackingaming.notesquirrel.sandbox.passingthrough.fragments.game.adapters;
...
public class ItemRecyclerViewAdapter extends RecyclerView.Adapter<ItemRecyclerViewAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        if (image != null) {
            Log.d(MainActivity.DEBUG_TAG, getClass().getSimpleName() + " image of item from backpack is not null");
