...
public class TileManagerLoader {
    public static String loadFileAsString(Resources resources, int resId) {
        Log.d(MainActivity.DEBUG_TAG, "TileLoaderWorldMapPart01.loadFileAsString(Resources resources, int resId)");
        ...
        try {
            ...
            ex.printStackTrace();
            Log.d(MainActivity.DEBUG_TAG, "Resources.NotFoundException - Unable to openRawResource(resId): " + resId);
        } catch (IOException ex) {
            ex.printStackTrace();
            Log.d(MainActivity.DEBUG_TAG, "IOException - Unable to read file (resId): " + resId);
        } finally {
            try {
                bufferedReader.close();
            } catch (IOException e) {
                e.printStackTrace();
                Log.d(MainActivity.DEBUG_TAG, "IOException Unable to close file (resId): " + resId);
            } catch (NullPointerException e) {
                e.printStackTrace();
                Log.d(MainActivity.DEBUG_TAG, "NullPointerException BufferedReader is null. File was probably never opened (resId): " + resId);
            }
        }
    ...
    public static Tile[][] convertStringToTiles(String stringOfTiles) {
        Log.d(MainActivity.DEBUG_TAG, "TileLoaderWorldMapPart01.convertStringToTiles(String stringOfTiles)");
    ...
    public static Tile[][] cropTilesFromFullWorldMap(Resources resources,
        ...
        Log.d(MainActivity.DEBUG_TAG, "TileLoaderWorldMapPart01.cropTilesFromFullWorldMap(Resources resources, int xStartTileIndex, int yStartTileIndex, int xEndTileIndex, int yEndTileIndex)");
    ...
    public static Bitmap cropImageFromFullWorldMap(Resources resources,
                                                   int xStartTileIndex, int yStartTileIndex,
                                                   int xEndTileIndex, int yEndTileIndex) {
        Log.d(MainActivity.DEBUG_TAG, "TileLoaderWorldMapPart01.cropImageFromFullWorldMap(Resources resources, int xStartTileIndex, int yStartTileIndex, int xEndTileIndex, int yEndTileIndex)");
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        Log.d(MainActivity.DEBUG_TAG, "Bitmap croppedWorldMapPart01's (width, height): " + croppedWorldMapPart01.getWidth() + ", " + croppedWorldMapPart01.getHeight());
